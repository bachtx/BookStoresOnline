...
?>
<div id="list">
<H1 align='center'>List Order Finished</H1>
  <form id="frm_list" name="frm_list" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
      <tr class="header">
		...
		<th width="50" align="center">Del</th>
      </tr>
      <?php 
	  $obj->getList(" WHERE `status`='2'",' ORDER BY `cdate` DESC ','');
	  $total_rows=$obj->Num_rows();
	  $num=0;
	  ...
	  <tr>
		...
		<td align='center'><span style='color:#333;'>Finished</span></td>
